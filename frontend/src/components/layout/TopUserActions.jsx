...
export const TopUserActions = ({ notificationText = 'Tu buzon de mensajes' }) => {
  ...
  return (
    <div className="flex items-center gap-2 xl:gap-4">
      <button
        type="button"
        className="flex items-center bg-slate-100 border border-slate-200 rounded-lg px-3 xl:px-4 py-1.5 gap-2 xl:gap-3 cursor-pointer hover:bg-slate-200 transition-all"
      >
