...
import { 
  Bell, ChevronDown, Download, BrainCircuit, Activity, Fingerprint, ShieldCheck 
} from 'lucide-react';
      ...
      <main className="p-8 w-full max-w-[1600px] mx-auto overflow-y-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
            ...
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-baseline gap-1">
                <span className="text-4xl font-extrabold text-slate-800">0.76</span>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
            ...
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-baseline gap-1">
                <span className="text-4xl font-extrabold text-blue-600">0.84</span>
                <span className="text-xs font-bold text-slate-500">/ 1.0</span>
              </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
            ...
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-baseline gap-1">
                <span className="text-4xl font-extrabold text-amber-500">89.2%</span>
              </div>
          ...
          <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm flex flex-col justify-between">
            ...
            <div className="flex justify-between items-center mb-4">
              <div className="flex items-baseline gap-1">
                <span className="text-4xl font-extrabold text-green-500">0</span>
             ...
             <table className="w-full text-left border-collapse">
               ...
               <tbody className="divide-y divide-slate-100 text-[11px] font-bold text-slate-800">
                 <tr className="hover:bg-slate-50 transition-colors">
                   ...
                   <td className="px-6 py-6">Calificación RAG enviada</td>
                   <td className="px-6 py-6">00245-2026-0-1801-JP-CI-01</td>
                   <td className="px-6 py-6">192.168.1.45</td>
                 </tr>
                 <tr className="hover:bg-slate-50 transition-colors">
                   <td className="px-6 py-6">02/05/2026 09:15</td>
                   <td className="px-6 py-6">Admin - Sede central</td>
                   <td className="px-6 py-6">Exportación masiva bloqueada</td>
                   <td className="px-6 py-6">Multiples</td>
                   <td className="px-6 py-6">10.0.0.12</td>
                 </tr>
                 <tr className="hover:bg-slate-50 transition-colors">
                   <td className="px-6 py-6">30/04/2026 10:30</td>
                   <td className="px-6 py-6">Admin - Sede central</td>
                   <td className="px-6 py-6">Modificación de Snapshot RAG</td>
                   <td className="px-6 py-6">00312-2026-0-1801-JP-FC-01</td>
                   <td className="px-6 py-6">10.0.0.15</td>
                 </tr>
               </tbody>
             </table>
           </div>
